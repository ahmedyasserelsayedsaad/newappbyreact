...
import { addtocart,deletefromcart } from '../rtk/sclices/CartSlices'
    ...
    <div>
      <div className="container">
        ...
        <div className="row">
         ...
         <img src={previewImg} alt={product.title} className='w-100 mainim' />
          </div>
          ...
          <button className="btnc" onClick={()=>addings(product)}>{adding}</button>
          </div>
        </div>
      </div>
    </div>
